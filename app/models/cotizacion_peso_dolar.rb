class CotizacionPesoDolar < ActiveRecord::Base
  ...
  def copiar_a_historico
    @attr = {:user_id => self.user_id_was, :cotizacion_peso_dolar => self, :valor_cents => self.valor_cents_was, :valor_currency => self.valor_currency_was, :fecha_de_alta => self.updated_at}
