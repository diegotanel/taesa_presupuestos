...
ActiveRecord::Schema.define(:version => 20121204182324) do
  ...
  add_index "partidas_contable", ["cliente_proveedor_id"], :name => "index_partidas_contable_on_cliente_proveedor_id"
  add_index "partidas_contable", ["deleted_at"], :name => "index_partidas_contable_on_deleted_at"
