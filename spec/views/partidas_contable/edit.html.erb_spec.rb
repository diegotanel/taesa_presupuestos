...
describe "partidas_contable/edit" do
  before(:each) do
  ...
  it "renders the edit partida_contable form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => partidas_contable_path(@partida_contable), :method => "post" do
